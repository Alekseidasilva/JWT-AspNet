            ...
            modelBuilder.Entity("JwtStore.Core.Contexts.AccountContext.Entities.User", b =>
                {
                    b.OwnsOne("JwtStore.Core.Contexts.AccountContext.ValueObjects.Email", "Email", b1 =>
                        {
                            ...
                            b1.OwnsOne("JwtStore.Core.Contexts.SharedContext.ValueObjects.Verification", "Verification", b2 =>
                                {
                    ...
                    b.OwnsOne("JwtStore.Core.Contexts.SharedContext.ValueObjects.Password", "Password", b1 =>
                        {
                            b1.Property<Guid>("UserId")
                                .HasColumnType("uniqueidentifier");
